...
export const cases: Case[] = [
    ...
    {
        id: 15,
        title: "Hernandez vs Highland Garden Apartments",
        emoji: "🏠",
        issues: [
            "Severe mold due to water leak",
            "Humidity issues on living room wall",
            "No action for two years",
            "Furniture moved repeatedly to address mold",
        ],
        outcome: [
            "Tenant awarded $7,050.60 rent refund",
            "40% reduction in property value awarded",
            "Landlord held liable for reduced habitability",
            "Landlord disputed tenant's maintenance claims",
        ],
        pdfUrl: "/petition/Escuela_222 2024.01.25 AppealDecision_Redacted.pdf",
    },
    {
        id: 16,
        title: "Castillo vs Roque",
        emoji: "💰",
        issues: [
            "Electrical issues in apartment outlets",
            "Severe cockroach infestation",
            "Water heater provided cold water",
            "Basement flooding from kitchen sink leak",
        ],
        outcome: [
            "Tenant awarded downward rent adjustment",
            "Issues caused major habitability reduction",
            "Repairs delayed; no rent paid from May 2022",
            "City inspection accelerated needed repairs",
        ],
        pdfUrl: "/petition/Higdon_1826 2023.02.23 HODecision_Redacted.pdf",
    },
    {
        id: 17,
        title: "Yaghoubzadeh vs TFT Investments",
        emoji: "🏚️",
        issues: [
            "Mold in garage and living room",
            "Living room wall leak not repaired",
            "Garage roof tarp only temporary fix",
            "Repeated tenant requests for maintenance",
        ],
        outcome: [
            "Tenant awarded $1,293 rent refund",
            "20% rent reduction due to mold",
            "Roof leak repair delays cited",
            "Landlord's compliance insufficient",
        ],
        pdfUrl: "/petition/Montecito_1260 2023.10.24 AppealDecision_Redacted.pdf",
    },
    {
        id: 18,
